...
var _eventbusEs = __webpack_require__(37);

var _eventbusEs2 = _interopRequireDefault(_eventbusEs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

setTimeout(function () {
	_eventbusEs2.default.$emit('handler');
	_eventbusEs2.default.$emit('handler2');
}, 1000);

setTimeout(function () {
	_eventbusEs2.default.$on('handler', function () {
		console.log('this is handler');
	});
	_eventbusEs2.default.$on('handler1', function () {
		console.log('this is handler');
	});
}, 1200);
...
module.exports = function (t) {
  var e = {};function r(i) {
    ...
    if (1 & e && (t = r(t)), 8 & e) return t;if (4 & e && "object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t)) && t && t.__esModule) return t;var i = Object.create(null);if (r.r(i), Object.defineProperty(i, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t) for (var n in t) {
      r.d(i, n, function (e) {
        return t[e];
      }.bind(null, n));
    }return i;
  ...
  "use strict";
  Object.defineProperty(e, "__esModule", { value: !0 });e.default = { triggerMap: {}, waitTriggerList: [], $on: function $on(t, e) {
      this.triggerMap[t] || (this.triggerMap[t] = e);var r = this.waitTriggerList.findIndex(function (e) {
        return e === t;
      });-1 !== r && (this.waitTriggerList.splice(r, 1), this.$emit(t));
    }, $emit: function $emit(t) {
      return this.triggerMap[t] ? this.triggerMap[t]() : this.waitTriggerList.find(function (e) {
        return e === t;
      }) ? void 0 : this.waitTriggerList.push(t);
    } };
}]);
